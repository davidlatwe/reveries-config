...
/usr/bin/docker exec -e PYTHONPATH=${pythonpath//$CONFIG_ROOT/$DOCKER_WORKDIR} \
					 -e AVALON_PROJECTS=${projects//$CONFIG_ROOT/$DOCKER_WORKDIR} \
					 ...
					 -e AVALON_WORKDIR=${workdir//$CONFIG_ROOT/$DOCKER_WORKDIR} \
